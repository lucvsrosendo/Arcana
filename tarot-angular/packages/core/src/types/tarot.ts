...
export type MinorTarotCardId = `${string}-of-wands` | `${string}-of-cups` | `${string}-of-swords` | `${string}-of-pentacles`;
...
export type MinorTarotCard = Omit<TarotCard, "id" | "dailyAdvice" | "symbols" | "correspondences"> & {
  id: string;
  nameShort: string;
  rank: string;
...
export type DeckCard = TarotCard | MinorTarotCard;
