    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Coletamos e-mail e senha para autenticação, nome de exibição, avatar, comentarios em notícias, curtidas, favoritos, pontos de experiência (XP), leituras e entradas de diário quando você opta por sincronizar na nuvem.",
            "Preferencias locais (tema, idioma, som, streak) ficam no navegador ate que você entre na conta.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Você pode exportar ou solicitar exclusão dos seus dados na pagina Conta. A exclusão remove leituras, diário, comentarios, interacoes, XP e perfil associados a sua conta.",
      ...
      sections: [
        {
          title: "Uso aceitavel",
          paragraphs: [
            "Você concorda em usar o portal de forma respeitosa, sem assedio, spam, conteudo ilegal ou tentativa de manipular XP, curtidas ou favoritos.",
          ],
        },
        {
        ...
        },
        {
          title: "Gamificacao",
          paragraphs: [
            "O sistema de XP e acumulativo e pode ser ajustado para corrigir abusos. Não ha garantia de níveis, recompensas financeiras ou permanencia de pontos após exclusão de conta.",
          ],
        },
        {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "A autenticação Supabase utiliza cookies e armazenamento seguro de sessão para manter você logado.",
          ],
        },
        {
          title: "localStorage",
          paragraphs: [
            "Guardamos preferências de tema, idioma, som, streak diário, favoritos de cartas e rascunhos locais quando você não esta sincronizado.",
          ],
        },
        {
          title: "Como desativar",
          paragraphs: [
            "Você pode sair da conta, limpar dados do site no navegador ou desativar cookies de terceiros. Isso pode impedir login e sincronizacao.",
          ],
        },
      ],
    },
